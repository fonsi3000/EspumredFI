...
use App\Filament\Litoral\Resources\CuentaIngresoLitoralResource\Pages;
...
class CuentaIngresoLitoralResource extends Resource
{
    protected static ?string $model = CuentaIngresoLitoral::class;
    ...
    {
        return [
            'index' => Pages\ListCuentaIngresoLitorals::route('/'),
        ];
    }
}

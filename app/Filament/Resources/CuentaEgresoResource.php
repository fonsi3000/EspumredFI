...
use App\Filament\Resources\CuentaEgresoResource\Pages;
...
class CuentaEgresoResource extends Resource
{
    protected static ?string $model = CuentaEgreso::class;
    ...
    {
        return [
            'index' => Pages\ListCuentaEgresos::route('/'),
        ];
    }
}
